<x-layouts.user-layout>
  ...
  <div id="exercises" class="section__exercises toggle__section">
    ...
    <div class="excercises__container">
      <div>
        <iframe width="1903" height="764" src="https://www.youtube.com/embed/V737pSc70yI" title="Test spa 11"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen></iframe>
      </div>
      ...
      {{-- <div class="box">
        <img class="box__img" src="{{ asset('assets/routine/exercises/ej1.gif') }}" alt="Ejercicio 1">
      ...
      <div class="box">
        <img class="box__img" src="{{ asset('assets/routine/exercises/ej2.gif') }}" alt="Ejercicio 2">
        <div class="box__title-cont">
      ...
      <div class="box">
        <img class="box__img" src="{{ asset('assets/routine/exercises/ej3.gif') }}" alt="Ejercicio 3">
        <div class="box__title-cont">
      ...
      <div class="box">
        <img class="box__img" src="{{ asset('assets/routine/exercises/ej4.gif') }}" alt="Ejercicio 4">
        <div class="box__title-cont">
      ...
      <div class="box">
        <img class="box__img" src="{{ asset('assets/routine/exercises/ej5.gif') }}" alt="Ejercicio 5">
        <div class="box__title-cont">
